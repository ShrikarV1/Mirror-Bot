...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Owner", "https://t.me/Shrikar2006")
    buttons.buildbutton("Authorised Group", "https://t.me/+6WqrscrxF2AzMmRl")
...
def bot_help(update, context):
    button = ButtonMaker()
    button.buildbutton("Other Commands", f"https://telegra.ph/Mirror-Leech-Bot-Commands-06-21")
